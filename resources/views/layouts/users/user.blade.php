                ...
                <form autocomplete="off" class="user__form" @submit.prevent="sendUser" method="POST">
                    <div class="col-md-6">
                        ...
                        <div class="form-group" :class="{ 'has-error': errors.password }">
                            <label class="control-label col-md-6 text-right" for="user-trial-ends">Trial ends on</label>
                            <div class="col-md-6">
                                <div class="input-group date" v-datepicker="user.trial_ends">
                                    <input id="user-trial-ends" type="text" class="form-control" :placeholder="user.date_format_php">
                                    <span class="input-group-addon">
                                        <i class="glyphicon glyphicon-th"></i>
                                    </span>
                                </div>
                                <span class="val-error" v-if="errors.trial_ends_at">@{{ errors.trial_ends }}</span>
                            </div>
                        </div>
