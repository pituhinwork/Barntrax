<div class="row" v-if="template.type == 'litter' && template.size == '2_3_business' && previewItem == 'litter.2_3_business' && template.orientation == 'horizontal'">
            ...
            <div class="row ">
                ...
                <div class="col-xs-4">
                    <p class="">
                        ...
                        <br><strong>@{{ getPreviewFieldName(firstLitter, 8, 'Died') }} </strong> @{{{ getPreviewFieldValue(firstLitter, 8, '2') }}}
