                ...
                <div class="form-group col-xs-7 col-sm-6">
                    ...
                    <div class="col-sm-8">
                        <select class="form-control" v-model="selectedLitter">
                            <option value="0" v-if="!litter || !litter.id">select litter</option>
...
--}}
                <div class="form-group col-xs-7 col-sm-6">
                    ...
                    <div class="col-sm-8">
                        <div id="datepick" class="input-group date" v-datepicker="date" container="#litter-weight-modal">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="form-group col-xs-7 col-sm-6">
                            ...
                            <div class="col-sm-8">
                                <input type="text" v-model="activeKit.color" class="form-control" v-autocomplete="activeKit.color" source="colors">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-xs-7 col-sm-6">
                            ...
                            <div v-if="activeKit.weight_unit != 'Pound/Ounces'" class="col-sm-8">
                                <input type="number" class="form-control" value="" v-model="activeKit.current_weight"
                                       name="weight" min="0" step=".1" v-autocomplete source="weights">
                            </div>
                            <div v-if="activeKit.weight_unit == 'Pound/Ounces'" class="col-sm-8">
                                <lbs-oz-input v-if="activeKit.weight_unit == 'Pound/Ounces'" :model="activeKit.id" :weight.sync="activeKit.current_weight"></lbs-oz-input>
                            </div>
                        </div>
            ...
            <div class="row" v-if="showNavigator">
                    ...
                    <div class="info-box" @click.prevent="setActiveKit(kit, index)" v-bind:class="getGenderClass(kit.sex)"
                        ...
                        <div class="info-box-content">
                            ...
                            <div v-if="!first" class="input-group input-group-sm"{{-- v-bind:class="{ has-success: kit.saved }"--}}>
                                ...
                                <input v-if="kit.weight_unit != 'Pound/Ounces'" type="number" class="form-control" value="" v-model="kit.current_weight" placeholder="Weight"
                                       name="message" min="0" step=".1" v-autocomplete source="weights">

                                <lbs-oz-input v-if="kit.weight_unit == 'Pound/Ounces'" reset="1" :model="kit" :weight.sync="kit.current_weight"></lbs-oz-input>
                            ...
                            <div style="margin-top: 5px">
                                <button v-if="first" @click.prevent="diedKit(kit)" class="btn btn-danger btn-xs pull-right">
                                    <i class="fa fa-heart-o"></i> Mark Died
                                </button>
                            </div>
                ...
                <div v-if="kits.length === weighedKits && litter" class="col-sm-12 text-center">
                    <h3>All Done!</h3>
                </div>
    ...
    <div class="modal-footer bg-warning">
        ...
        <button :disabled = "!litter" v-if="kits.length == weighedKits" class="btn btn-warning" @click="saveAll" type="button">Save changes</button>
