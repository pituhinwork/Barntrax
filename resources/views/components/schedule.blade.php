    ...
    <section class="content-header">
        ...
        <div class="btn-group">
            ...
            <ul role="menu" class="dropdown-menu">
              <li><a v-link="{ path: '/schedule', activeClass: 'bold', exact: true }">All</a></li>
              <li><a v-link="{ path: '/schedule/general', activeClass: 'bold', exact: true }">General</a></li>
              <li><a v-link="{ path: '/schedule/breeder', activeClass: 'bold', exact: true }">Breeders</a></li>
              <li><a v-link="{ path: '/schedule/litter', activeClass: 'bold', exact: true }">Litters</a></li>
              <li class="divider"></li>
              <li><a v-link="{ path: '/schedule/archived', activeClass: 'bold', exact: true }">Archived</a></li>
              <li class="divider"></li>
              <li><a v-link="{ path: '/schedule/plans', activeClass: 'bold', exact: true }">Plans</a></li>
              <li class="divider"></li>
              <li><a v-link="{ path: '/schedule', query: { new: true }, exact: true }">Add New</a></li>
            </ul>
          </div>
