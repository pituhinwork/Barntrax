<template id="schedule-calendar-template">
    ...
    <section class="col-sm-6 col-md-7 col-lg-8 home-schedule">
        <div style="" class="box box-solid box-primary ">
            <div class="box-header">
                ...
                <!-- /. tools -->
                @if (Auth::check())
                    <a href="/ics/{{ Auth::id() }}/{{ CryptHash::hash('user:' . Auth::id() . ':schedule') }}"
                       onclick="App.vent.trigger('export-schedule'); return false"
                       class="btn btn-outline btn-sm pull-right" title="Export to Calendar" id="step6"><i class="fa fa-calendar-plus-o"></i></a>
                @endif
            </div><!-- /.box-header -->
            <div class="box-body">
