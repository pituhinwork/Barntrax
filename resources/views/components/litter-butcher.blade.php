        ...
        <form class="form-horizontal row-paddings-compensation">
            <div class="row">
                ...
                <div class="form-group col-xs-7 col-sm-6 col-xs-12">
                    ...
                    <div class="col-sm-8">
                        <div id="datepick" class="input-group date" v-datepicker="date" container="#litter-butcher-modal">
                ...
                <div class="col-xs-12">
                    ...
                    <table class="table table-hover">
                        ...
                        <tr v-for="kit in kits" v-bind:class="getGenderClass(kit.sex)">
                            ...
                            <td>@{{ kit.color }}</td>
                            <td>
                                <input type="text" v-if="kit.weight_unit != 'Pound/Ounces'" data-mobile-type="number" v-model="kit.current_weight" class="form-control js_only-numbers">

                                <lbs-oz-input v-if="kit.weight_unit == 'Pound/Ounces'" :model="kit" :weight.sync="kit.current_weight"></lbs-oz-input>
