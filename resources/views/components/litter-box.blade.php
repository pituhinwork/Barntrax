...
--}}
        ...
        <!-- small box -->
        <div class="small-box bg-gray box collapsed-box" v-if="litter.kits_died">
            <a data-widget="collapse" href="#">
                <div class="collapsed-box box-grey-active box-header text-muted inner">
            ...
            <div class="box-body" style="display:none">
                <ul class="list-group">
                    <li v-for="kit in died" class="list-group-item text-black">
                        <a href="#" class="pull-right label label-success" @click.prevent="revive(kit)">undo</a> @{{ kit.given_id }}
                    </li>
                </ul>
            </div>
        </div>
